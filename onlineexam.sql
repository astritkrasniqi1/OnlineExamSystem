...
-- Database: `onlineexam`
--
CREATE DATABASE IF NOT EXISTS `onlineexam` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `onlineexam`;
...
('root', '[{\"db\":\"onlineexam\",\"table\":\"users\"},{\"db\":\"onlineexam\",\"table\":\"exam\"}]');
...
('root', '2023-03-30 18:47:18', '{\"Console\\/Mode\":\"collapse\"}');
